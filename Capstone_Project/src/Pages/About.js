...
import ChandraImage from '../Assets/chandraw.jpg';
    ...
    return(
        <section className="about-us-container">            
            ...
            <section className="Our Team">
                <h3>Meet Our Team</h3> 
                <p>The Coding Guppies was founded by 3 students from the NPower Path2Tech Spring 2024 Cohort</p><br></br>
                
                <img alt="simone moore" src={SimoneImage} width="50" height="50" padding="10px"/>Simone Moore<br></br>
                <img alt="yarmin reyes" src={YarminImage} width="50" height="50"/>Yarmin Reyes<br></br>
                <img alt="chandra white" src={ChandraImage} width="50" height="50"/>Chandra White<br></br>
            ...
            <section className="Our Story"> 
                ...
                <p>We started this website to help reduce clothing waste out of a shared passion for sustainability and a 
                    ...
                    ultimately contributing to a greener and more conscientious world.</p><br></br>
            </section>
        </section>
    )
}
